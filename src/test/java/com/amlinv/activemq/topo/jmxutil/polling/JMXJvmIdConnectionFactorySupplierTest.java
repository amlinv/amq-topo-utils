 ...
 */
public class JMXJvmIdConnectionFactorySupplierTest {

    private JMXJvmIdConnectionFactorySupplier supplier;

    @Before
    public void setupTest() throws Exception {
        this.supplier = new JMXJvmIdConnectionFactorySupplier();
    }

    @Test
    public void testHandlesLocation() throws Exception {
        assertTrue(this.supplier.handlesLocation("jvmId=1355"));
        assertTrue(this.supplier.handlesLocation("pid=1355"));
    ...
    public void testCreateFactory() throws Exception {
        assertTrue(this.supplier.createFactory("jvmId=1355") instanceof JMXJvmIdConnectionFactory);
    }
}
