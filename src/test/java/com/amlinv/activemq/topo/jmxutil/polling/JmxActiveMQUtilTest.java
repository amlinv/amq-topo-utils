...
public class JmxActiveMQUtilTest {
    ...
    public void testQueryBrokerNames() throws Exception {
        Mockito.when(this.mockConnection.queryNames(new ObjectName(JmxActiveMQUtil.AMQ_BROKER_QUERY), null))
                .thenReturn(new HashSet<>(Arrays.asList(
                        new ObjectName("x-domain-x:" + JmxActiveMQUtil.AMQ_BROKER_NAME_KEY + "=broker1"),
                        new ObjectName("x-domain-x:" + JmxActiveMQUtil.AMQ_BROKER_NAME_KEY + "=broker2")
                )));
    ...
    public void testQueryQueueNames() throws Exception {
        ...
        Mockito.when(this.mockConnection.queryNames(new ObjectName(pattern), null))
                .thenReturn(new HashSet<>(Arrays.asList(
                        new ObjectName("x-domain-x:" + JmxActiveMQUtil.AMQ_QUEUE_NAME_KEY + "=queue1"),
                        new ObjectName("x-domain-x:" + JmxActiveMQUtil.AMQ_QUEUE_NAME_KEY + "=queue2")
                )));
